...
class MAIL:
    ...
    def __init__(self):
        ...
        self.loginUrl = """https://mail.163.com/entry/cgi/ntesdoor?style=-1&df=mail163_letter&net=&language
        =-1&from=web&race=&iframe=1&product=mail163&funcid=loginone&passtype=1&allssl=tr
        ue&url2=https://mail.163.com/errorpage/error163.htm"""
        # 设置代理，以防止本地IP被封
        ...
        # 设置用户名和密码，填上自己的即可
        self.username = 'niujt123@163.com'
        self.pwd = 'niujiatao123'
        # post所包含的参数
        self.post = {
            'savelogin': "0",
    ...
    def messageList(self):
        # 重定向至收件箱的网址
        listUrl = """http://mail.163.com/js6/s?sid=%s&func=mbox:listMessages&TopTabReaderShow=1&
        TopTabLofterShow=1&welcome_welcomemodule_mailrecom_click=1&LeftNavfolder1Click=1&mbox_folder_enter=1'%self.sid"""
        # 新的请求头
        Headers = {
